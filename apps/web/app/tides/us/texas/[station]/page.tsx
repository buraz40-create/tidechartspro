...
import { getStationBySlug, getAllSlugs, TEXAS_STATIONS } from '@/lib/texas-stations'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `https://tidechartspro.com/tides/us/texas/${slug}`
    ...
    '@graph': [
      {
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Texas', item: 'https://tidechartspro.com/tides/us/texas' },
...
export default async function StationPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <TideLocationPage station={{ ...station!, nearby: computeNearby(station!, TEXAS_STATIONS) }} />
    </>
  )
}
