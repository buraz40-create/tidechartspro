...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    `${cityAL} tide chart with live tide levels, tides for fishing, solunar periods ` +
  ...
  return {
    ...
    keywords: [
      ...
      `${city.toLowerCase()} AL tide chart`,
      `alabama tide chart`,
      `alabama tides for fishing`,
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: `The mean tidal range in ${city} is approximately ${s.meanRange} feet. ${s.tidalType === 'diurnal' ? 'Gulf Coast tides are diurnal — predominantly one high and one low tide per day.' : 'Tides are mixed — two unequal high and low tides per day.'}` },
          },
        ],
      },
    ],
